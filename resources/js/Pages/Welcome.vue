...
<template>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div class="relative flex justify-center max-h-screen">
            <div
                class="absolute h-full md:h-auto bg-slate-800 opacity-50 inset-0 md:hidden"
            ></div>
            <img
        ...
        >
            <div
                class="text-white md:text-slate-900 p-5 rounded-md md:h-1/2 flex flex-col justify-center items-center"
            >
                <p class="text-5xl md:text-7xl font-bold">Toscana Memmingen</p>
                <p
                    class="mt-5 text-xl hidden md:inline-block text-justify leading-relaxed whitespace-pre-wrap"
                >
                ...
                <div class="flex flex-col md:flex-row md:gap-5 text-sm">
                    <Button
                        class="mt-10 flex justify-center items-center gap-5"
                    >
                        <GlobeIcon />
                    ...
                    <Button
                        variant="secondary"
                        class="mt-5 md:mt-10 flex justify-center items-center gap-5"
                    >
                        <svg
...
.line {
    height: 8px;
    padding: 0 5px;
    background: url("https://losteria.net/typo3conf/ext/losteria/Resources/Public/img/dotted_line_part_black.png")
        repeat-x;
